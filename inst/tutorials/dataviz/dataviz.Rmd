...
```{r pie2, exercise = TRUE, exercise.eval = TRUE, exercise.setp = "pie1"}
...
```{r pie3-2, exercise = TRUE, exercise.eval = TRUE, exercise.setp = "pie3"}
...
```{r pie4, exercise = TRUE, exercise.eval = TRUE, exercise.setp = "pie3"}
...
```{r pie5, exercise = TRUE, exercise.setp = "pie3"}
...
```{r zero2, exercise = TRUE, exercise.eval = TRUE, exercise.setp = "zero1"}
# Restrict the range
...
```{r reorder2, exercise = TRUE, exercise.eval = TRUE, exercise.setp = "reorder1"}
data_murders %>%
...
```{r reorder3, exercise = TRUE, exercise.eval = TRUE, exercise.setp = "reorder1"}
data_murders %>%
...
```{r reorder4, exercise = TRUE, exercise.setp = "reorder1"}
data_murders
```
