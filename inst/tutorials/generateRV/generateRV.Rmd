...
With a bit of calculus, we can check that the ratio is maximised at $x = \pm 1$, with value $2/\sqrt{e}$. Therefore, we can use $c=2/\sqrt{e} \approx 1.2131$ as our constant.
...
If we want to use a discrete uniform for $g$, the ratio is maximised when $j=9,10$, in which case
